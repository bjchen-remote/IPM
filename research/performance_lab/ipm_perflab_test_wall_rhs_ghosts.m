function report=ipm_perflab_test_wall_rhs_ghosts(outputDirectory)
    ...
    for stretch=registration.stretch
        ...
        for boundary=registration.boundaryModes
            ...
            for k=1:size(registration.rates,1)
                ...
                [wall,wallBase,wallA1]=ipm_perflab_wall_rhs_ghosts(rho,u1,q(1),q(3),q(4),ops);
...
fprintf('WALL_RHS_GHOSTS_TINY passed=%d cases=%d exact=%d maxInf=%.6g\n',passed,item, ...
