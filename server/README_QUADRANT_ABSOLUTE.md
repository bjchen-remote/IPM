...
`/data/user/hd58131/ipm/ipm_long_time_server_20260914`，再把该包中的
`main.m` 复制到独立服务器作业目录，并按**复制件的绝对路径**运行。
`main.m` 只用 `mfilename('fullpath')` 定位 `jobRoot`；源码
`releaseRoot='/data/user/hd58131/ipm/ipm_long_time_server_20260914'` 是固定字面量，
...
`ipm_long_time_server_20260914` 目录、ZIP 与 SHA-256 清单。
