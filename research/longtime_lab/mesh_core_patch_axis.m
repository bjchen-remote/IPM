function [x,info]=mesh_core_patch_axis(anchor,coreCenter,halfWidth,nodeCount,spacing,fineCells,fineFraction,roundingCells,warpRadius)
%MESH_CORE_PATCH_AXIS Core-centered candidate; exact anchor via a C2 warp.
...
[base,baseInfo]=mesh_general_rounded_axis(coreCenter/anchor,halfWidth/anchor, ...
