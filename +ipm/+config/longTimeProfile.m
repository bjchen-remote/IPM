...
if ~isnumeric(s.meshDensityVersion) || ~isscalar(s.meshDensityVersion) || ...
        ...
        ~any(s.meshDensityVersion==[0,1]) || ...
        (s.meshDensityVersion==1 && s.autonomousMeshVersion~=5)
    error('ipm:BadLongTimeProfileSettings', ...
        'meshDensityVersion must be 0, or 1 with autonomousMeshVersion=5.');
end
...
if s.meshDensityVersion==1
    opts.autonomousMesh.densityVersion=1;
    opts.caseMetadata.meshDensityVersion=1;
end
...
assert(config.remesh.remeshMaximumCellRatio == ...
    ...
    config.remesh.autonomousMesh.densityVersion==1), ...
