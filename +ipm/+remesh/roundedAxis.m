function [axis,info]=roundedAxis(anchor,halfWidth,nodeCount,fineSpacing,fineCells,anchorFraction,roundingCells)
...
for k=1:80
    ...
    if mid==lower || mid==upper,slope=mid;return;end
