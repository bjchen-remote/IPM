...
```bash
cd ipm_long_time_server_v5_mesh_followup_20260913
...
```matlab
addpath('/absolute/path/to/ipm_long_time_server_v5_mesh_followup_20260913');
settings = struct( ...
...
```bash
matlab -batch "addpath('/absolute/path/to/ipm_long_time_server_v5_mesh_followup_20260913/server'); profile_status('/data/ipm/run01');"
```
...
```matlab
addpath('/absolute/path/to/ipm_long_time_server_v5_mesh_followup_20260913');
addpath('/absolute/path/to/ipm_long_time_server_v5_mesh_followup_20260913/tests');
