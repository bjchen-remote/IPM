function [checkpoint,audit,fileName] = ipm_gridlab_regrid_checkpoint( ...
        inputCheckpoint,candidateX,candidateY,options)
%IPM_GRIDLAB_REGRID_CHECKPOINT Transactionally regrid a trusted checkpoint.
...
% Transfer and the old-state audit use derivative/quadrature/geometry data,
% never the old elliptic factor. Release it before retaining oldState and
% building the new factor, so both decompositions need not coexist.
